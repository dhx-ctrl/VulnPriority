    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div>
        ...
        <p style={{ fontSize: 14, color: sub, margin: 0 }}>
          Sync findings from DefectDojo and score them with both AI models
        </p>
      </div>
      <div
        style={{
        ...
        <GlassCard>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              />
              {
                ...
                products.length > 0 ? (
                          ...
                          style={{
                            ...
                            background:
                              selectedProductId === p.id
                                ? dark
                                  ? "rgba(56,132,244,0.18)"
                                  : "rgba(56,132,244,0.10)"
                                : "transparent",
                  ...
                  <div style={{ fontSize: 11, color: muted, marginTop: 4 }}>
                    {productsError ? (
                      <span style={{ color: "#ef4444" }}>{productsError}</span>
                    ) : (
            ...
            <div>
              ...
              />
              <div style={{ fontSize: 11, color: muted, marginTop: 4 }}>
                Max findings to fetch per sync
              </div>
            </div>
            <div>
              <label
              ...
              >
                Skip closed or archived engagements
              </div>
            </div>
            <button
              onClick={handleSync}
        ...
        <div>
            ...
            <GlassCard>
              ...
              >
                {[
                  ...
                  {
                    label: "Strict Op. Alerts",
                    val: result.high_risk_flagged,
                    highlight: true,
                  },
                  ...
                  {[
                    ...
                    <div
                      ...
                      style={{
                        ...
                        background: c,
                        borderRadius:
                          i === 0 ? "4px 0 0 4px" : i === 3 ? "0 4px 4px 0" : 0,
                      }}
                    />
                  ))}
                </div>
              ...
              {syncTime && (
                ...
                >
                  {"Synced at " +
                    syncTime.toISOString().replace("T", " ").slice(0, 19) +
                    " UTC"}
                </div>
              )}
              <div
                style={{
                  ...
                  borderRadius: 6,
                  background: dark
                    ? "rgba(56,132,244,0.08)"
                    : "rgba(56,132,244,0.05)",
                  fontSize: 12,
                  color: sub,
                }}
              >
          ...
          )}
          {
            ...
            syncState === "idle" && !result && (
              ...
              >
                <NavIcon name="sync" size={32} />
                <div style={{ fontSize: 14, color: muted, marginTop: 12 }}>
                  Configure and run a sync to score findings with both AI models
                </div>
              </GlassCard>
            )
          }
          {
            ...
            syncState === "error" && (
              ...
              >
                ...
                >
                  {error || "Check backend connection at http://127.0.0.1:8000"}
                </div>
              </GlassCard>
            )
          }
