  ...
  return (
    ...
    >
      <div>
        ...
        >
          Model thresholds are loaded from backend metadata. This page explains
          the active scoring setup and stores UI preferences only.
        </p>
      </div>
      ...
      >
        ...
        >
          Changing values on this page does not retrain XGBoost and does not
          edit model metadata. The active model thresholds are stored in the
          model output folders and loaded by the backend. Scanner severity,
          CVSS, Rank /100, and Clean /100 should be interpreted together during
          review.
        </div>
      </Section>
    </div>
