...
export default function UsersPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div>
        <h1
          style={{ fontSize: 24, fontWeight: 850, color: t, margin: "0 0 4px" }}
        >
          Users
        </h1>
              ...
              <tbody>
                {users.length === 0 && (
                  <tr>
                    <td
                      colSpan={7}
                      style={{ padding: 30, textAlign: "center", color: sub }}
                    >
                ...
                {users.map((u) => {
                  const status =
                    u.access_status || (u.is_active ? "approved" : "pending");
                      ...
                      <td style={{ padding: "12px 14px" }}>
                        ...
                        >
                          <button
                            ...
                            onClick={() =>
                              updateUser(u.id, { access_status: "approved" })
                            }
                            style={btn(
                              "#22c55e",
                          ...
                          <button
                            ...
                            onClick={() =>
                              updateUser(u.id, { access_status: "disabled" })
                            }
                            style={btn(
                              "#ef4444",
                              busy || status === "disabled",
                            )}
                          >
                            Disable
                          </button>
