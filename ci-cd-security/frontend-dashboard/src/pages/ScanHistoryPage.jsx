...
function ScanHistoryPage() {
  ...
  return React.createElement('div', { style: { display: 'flex', flexDirection: 'column', gap: 20 } },
    React.createElement('div', null,
      ...
      React.createElement('p', { style: { fontSize: 14, color: sub, margin: 0 } }, 'Scan timeline grouped by product, using operational rank score and scanner severity.'),
    ),
    // Filters
        ...
        React.createElement('table', { style: { width: '100%', borderCollapse: 'collapse' } },
          React.createElement('thead', null,
            React.createElement('tr', null,
              ['Product', 'Engagement', 'Commit', 'Branch', 'Scanned', 'Tools', 'Findings', 'Review First', 'Avg Rank', 'Status'].map(h =>
